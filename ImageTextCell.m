...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView{
	...
	//TODO: Selection with gradient and selection color in white with shadow check out http://www.cocoadev.com/index.pl?NSTableView
...
- (NSString*) secondaryTextForCell: (ImageTextCell*) cell data: (NSObject*) data{
	if(primaryTextKeyPath) return [data valueForKeyPath: secondaryTextKeyPath];
