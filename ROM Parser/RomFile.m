...
- (NSString *) determinedChecksum	{ return _determinedChecksum; }
...
- (NSString *) determinedSize		{ return _determinedSize; }
...
- (void)setDeterminedChecksum:	(NSString *) determinedChecksum{[_determinedChecksum autorelease];	_determinedChecksum = [determinedChecksum copy];	}
...
- (void)setDeterminedSize:		(NSString *) determinedSize		{[_determinedSize autorelease];		_determinedSize = [determinedSize copy];			}
...
- (void)dealloc{
	...
	[self setDeterminedChecksum:nil];
